...
-- I was copying over the terminal output, but each item in this database is massive and won't format correctly here. So, it worked. Will comment if that changes.
